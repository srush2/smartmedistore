    ...
    <div class="shell">
      <div class="container">
        <div class="row">
          ...
          <?php
          $i = 1;
          $stmt = $admin->ret("SELECT * , `stock` FROM `product`");
                ...
                <div class="wsk-cp-text">
                  <div class="category">
                    <span>
                        ...
                        <a href="offlinesearch.php" class="" style="color:white"><?php echo $row['rack']; ?></a>
                  ...
                  <div class="card-footer">
                    <div class="wcf-left"><span class="price">₹<?php echo $row['cost']; ?></span></div>
                      ...
                      <?php if($row['stock']==0){?> <h6 style="color:red">Out of Stock</h6><?php }else{ ?>   <h6 style="color:green"> stock: <?=$row['stock']; ?></h6><?php } ?>
